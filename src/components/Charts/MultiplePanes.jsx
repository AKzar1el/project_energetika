...
return (
  <ChartComponent id='multiplePanes' primaryXAxis={primaryxAxis} primaryYAxis={primaryyAxis} selectionMode='Series' tooltip={{ enable: true }}>
      ...
      <SeriesCollectionDirective>
          <SeriesDirective dataSource={data} xName='x' yName='y' name='Proizvodnja iz domačih virov' type='Column'>
          </SeriesDirective>
          <SeriesDirective dataSource={data} xName='x' yName='y1' name='Poraba električne energije' type='Column'>
          </SeriesDirective>
